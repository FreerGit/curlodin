...
CurlOption :: enum {
	...
	CURLOP_WRITEDATA        = CURLOPTTYPE_CBPOINT + 1,
}
...
@(default_calling_convention = "c", link_prefix = "curl_easy_")
foreign libcurl {
	init :: proc() -> CurlEasy ---
	setopt :: proc(handle: CurlEasy, opt: CurlOption, url: cstring) -> CurlCode ---
	perform :: proc(handle: CurlEasy) -> CurlCode ---
	cleanup :: proc(handle: CurlEasy) -> rawptr ---
}
